...
== 教育经历
#item[2023.9 \~ 2027.6][孝陵卫皇家炮兵学院][智能火炮电力电子]
#set text(size: 9pt)
*主要经历：*
...
- 开发并参与直流电机-滚珠丝杠-滑台系统的调试，在解决无绝对编码器的直线零点标定问题中，仿照3D打印机热床调平功能做了自动标定，最终无制导飞镖的CEP（圆概率偏差）能稳定控制在1/400，并在过程中能够及时发现提出机械上的问题反馈给队友进行改进
